...
print('Zero Shot Accuracy on validation set:', accuracy)
...
for epoch in range(num_epochs):
    ...
    if eval_loss < min_eval_loss:
        model.save_pretrained("Model/shape_blip-saved-model", from_pt=True) 
        print("Saved model to Model/shape_blip-saved-model")
...
pickle.dump(tracking_information, open("shape_tracking_information.pkl", "wb"))
